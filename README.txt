...
jsTimers-rAF hack is useful if you want use requestAnimationFrame into your scripts without change the code
or if you want to use a own version of setTimeout and setInterval methods.
